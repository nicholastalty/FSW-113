...
// })
// if (oldMovies) {
//     document.querySelector('#oldMovies').innerText = 'No'
// } else {
//     document.querySelector('#oldMovies').innerText = 'Yes'
// }
// --------------------------------------------------------------------
...
// const totalGross = movies.reduce(function(currentTotal, movie) {
//     return movie.gross + currentTotal
// },
// 0)
// document.querySelector('#avgGross').innerText =
